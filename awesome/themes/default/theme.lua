...
theme.taglist_fg_urgent = xrdb.color2
theme.taglist_fg_volatile = xrdb.color3

-- TASK list theme
theme.tasklist_fg_empty = xrdb.color8
theme.tasklist_fg_focus = xrdb.color4
theme.tasklist_fg_occupied = xrdb.color2
theme.tasklist_fg_urgent = xrdb.color1
theme.tasklist_fg_volatile = xrdb.color3
...
theme.menu_fg_focus = xrdb.color4
